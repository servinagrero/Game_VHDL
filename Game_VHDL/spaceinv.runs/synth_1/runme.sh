...
HD_PWD='C:/Users/edudv/Desktop/VHDL_projects/spaceinv/spaceinv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpaceInv.tcl
