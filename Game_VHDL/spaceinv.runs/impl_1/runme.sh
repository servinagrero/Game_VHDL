...
HD_PWD='C:/Users/edudv/Desktop/VHDL_projects/spaceinv/spaceinv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SpaceInv.tcl -notrace
